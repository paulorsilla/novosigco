...
class SublotacaoController extends ActionController
{
	...
	*/
	...
	{
        $sublotacoes = $this->getEntityManager()
                      ->getRepository("Application\Model\Sublotacao")
	...
	public function buscasublotacoesAction()
	{
		...
		if ($request->isPost()) {
			$sublotacoes = $this->getEntityManager()->getRepository("Application\Model\Sublotacao")->findAll(array(), array('descricao' => 'ASC'));
