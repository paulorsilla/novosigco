...
class OutraFuncaoController extends ActionController {
	...
	public function indexAction() {
		$funcoes = $this->getEntityManager ()->getRepository ( "Application\Model\OutraFuncao" )->findAll ( array (), array (
				'descricao' => 'ASC' 
		) );
	...
	public function buscaoutrasfuncoesAction() {
		...
		if ($request->isPost ()) {
			$outrasFuncoes = $this->getEntityManager ()->getRepository ( "Application\Model\OutraFuncao" )->findAll ( array (), array (
					'descricao' => 'ASC' 
			) );
