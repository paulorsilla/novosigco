...
class SubareaController extends ActionController {
	...
	public function indexAction() {
		$areas = $this->getEntityManager ()->getRepository ( "Application\Model\Area" )->findAll ( array (), array (
				'descricao' => 'ASC' 
		) );
	...
	public function buscasubareasAction() {
		...
		if ($request->isPost ()) {
			...
			$subareas = $this->getEntityManager ()->getRepository ( 'Application\Model\Subarea' )->findBy ( array (
					'area' => $area 
			), array (
					'descricao' => 'ASC' 
			) );
